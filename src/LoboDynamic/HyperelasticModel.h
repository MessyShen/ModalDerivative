...
#include "LoboDynamic/DynamicModel.h"
...
public:
    ...
    void setMaterial(const std::string material_type,
    ...
    virtual void computeEnergySparse(
        Eigen::VectorXd *free_variables, double *energy,
        Eigen::VectorXd *jacobi, Eigen::SparseMatrix<double> *hessian,
        std::vector<int>
            constmap);
    ...
    virtual void computeFq_Gq_full(Eigen::VectorXd &full_u,
                                   Eigen::VectorXd &f_u,
                                   Eigen::MatrixXd &g_u, 
                                   int computationflags);
    virtual void computeReducedEnergy(Eigen::VectorXd *free_variables,
                                      ...
                                      int computationflags);
    virtual void computeReducedEnergy(Eigen::VectorXd *free_variables, double *energy,
                                      Eigen::VectorXd *fullspace_f,
                                      Eigen::SparseMatrix<double> *hessian,
                                      std::vector<int> *w_indices, Eigen::VectorXd *weights,
                                      int computationflags);
